...
def country_choice_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="🇰🇿 Казахстан", callback_data="country:kz")],
        [InlineKeyboardButton(text="🇷🇺 Россия", callback_data="country:ru")],
        [InlineKeyboardButton(text="🇧🇾 Беларусь", callback_data="country:by")],
        [InlineKeyboardButton(text="🌍 Другая", callback_data="country:other")],
        [InlineKeyboardButton(text="₿ Криптовалюта", callback_data="country:crypto")],
    ])
